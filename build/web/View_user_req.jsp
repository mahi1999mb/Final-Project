    ...
    <body id="top">
            ...
            <div id="topbar">
                <div id="topnav">
                    <ul>
                        ...
                        <li class="active"><a href="View_user_req.jsp">View User Request</a></li>
        ...
        <div class="wrapper col3">
            <div id="container">
                ...
                <div id="container">
                    <center>
                        <h1 style="color: white;">User Requests</h1>
                    </center><br>
                    ...
                    <%
                        ...
                        try {
                            ...
                            ResultSet rs = st1.executeQuery("Select * from request where file_req = 'Request_sent' ");
                            while (rs.next()) {
