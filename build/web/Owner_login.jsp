    ...
    <body id="top">
        ...
        <div class="wrapper col3">
            <div id="container">
                ...
                <center>
                    <h1 style="color: white;">Data Owner Login</h1>
                </center><br>
                <center>
                    <form action="owner_signin.jsp" method="post">
                        <p>
                    ...
                    <div>
                        <p style="color: white;">Not a registered user yet? <strong><a href="owner_signup.jsp" class="blue-text">Sign up now!</a></strong></p>
                    </div>
                </center>
            </div>
