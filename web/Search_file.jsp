    ...
    <body id="top">
        ...
        <div class="wrapper col3">
            <div id="container">
                <!-- Page Heading -->
                <center>
                    <h1 style="color: white;">Search File Here!</h1>
                </center><br>
                <center>
                    <div id="container">
                        <form action="Search_action.jsp" method="post">
                            <p style="color: white;">Enter File Keyword:</p>
                            <input type="text" placeholder="Enter File key" name="fname" required="Fill Data" size="30"><br><br>
                            <p style="color: white;">Enter Search Token:</p>
                            <input type="text" placeholder="Enter Search Token" name="token" required="Fill Data" size="30"><br><br>
                            <input type="submit" name="search" value="Search" style="width: 100px; height: 40px; color: green" />
